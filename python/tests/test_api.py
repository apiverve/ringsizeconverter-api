...
class TestRingsizeconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = RingsizeconverterAPIClient(self.api_key)

    @patch('apiverve_ringsizeconverter.apiClient.requests.get')
