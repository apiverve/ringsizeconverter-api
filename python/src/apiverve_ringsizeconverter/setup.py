...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/ringsizeconverter',
        'Source': 'https://github.com/apiverve/ringsizeconverter-api',
        'Bug Tracker': 'https://github.com/apiverve/ringsizeconverter-api/issues'
    },
    classifiers=[
