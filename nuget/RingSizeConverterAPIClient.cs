...
namespace APIVerve.API.RingSizeConverter
{
    ...
    /// <summary>
    /// Client for the RingSizeConverter API
    /// </summary>
    public class RingSizeConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/ringsizeconverter";
        ...
        public RingSizeConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RingSizeConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RingSizeConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RingSizeConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RingSizeConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(RingSizeConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RingSizeConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RingSizeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RingSizeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RingSizeConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RingSizeConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RingSizeConverterQueryOptions options)
        {
