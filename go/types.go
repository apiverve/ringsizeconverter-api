...
// Request contains the parameters for the Ring Size Converter API.
//
// Parameters:
...
// ResponseData contains the data returned by the Ring Size Converter API.
type ResponseData struct {
	InputDiameterMm float64 `json:"input_diameter_mm"`
