// Package ringsizeconverter provides a Go client for the Ring Size Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/ringsizeconverter?utm_source=go&utm_medium=readme
package ringsizeconverter
...
const (
	baseURL        = "https://api.apiverve.com/v1/ringsizeconverter"
	defaultTimeout = 30 * time.Second
)

// Client is the Ring Size Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Ring Size Converter API client.
...
// Execute makes a request to the Ring Size Converter API with typed parameters.
//
...
//   - size (required): string - The ring size to convert
