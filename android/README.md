# Ring Size Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:ringsizeconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.ringsizeconverter.RingSizeConverterAPIClient;
import com.apiverve.ringsizeconverter.APIResponse;
import com.apiverve.ringsizeconverter.APIException;

// Initialize the client
RingSizeConverterAPIClient client = new RingSizeConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("size", "7");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ringsizeconverter](https://docs.apiverve.com/ref/ringsizeconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/ringsizeconverter](https://docs.apiverve.com/ref/ringsizeconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ringsizeconverter-api/issues)
